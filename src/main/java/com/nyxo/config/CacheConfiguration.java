...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("CustomerRelationshipManagement");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("CustomerRelationshipManagement");
        ...
        config.getMapConfigs().put("com.nyxo.domain.*", initializeDomainMapConfig(jHipsterProperties));
